...
define config.name = _("Ushio_Noa")
...
define config.main_menu_music = "audio/Theme_46_01.mp3"
...
define config.save_directory = "noa-1712660330"
...
init python:
    ...
    build.classify('game/config.json', None)
    build.classify('game/history', None)
